...
func (app *Application) readLine(session *pager.Session[Line], prompt, defaults string) (string, error) {
	nop := func(*readline.Editor) {}
	return app.readLineOpt(session, prompt, defaults, nop)
}

func (app *Application) readLinePath(session *pager.Session[Line], prompt, defaults string) (string, error) {
...
func (app *Application) readLineElement(session *pager.Session[Line], prompt, defaults string) (string, error) {
	opt := func(editor *readline.Editor) {
...
func (app *Application) readLineString(session *pager.Session[Line], prompt, defaults string) (string, error) {
...
func (app *Application) readLineOpt(session *pager.Session[Line], prompt, defaults string, opt func(*readline.Editor)) (string, error) {
...
func askYesNo(session *pager.Session[Line], message string) (bool, error) {
